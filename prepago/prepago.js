...
function online(online) {
	...
	if (continuar) {
		...
		if (online) {
			...
			// // document.getElementById("dolar").removeEventListener('click', reportedolar);
			// document.getElementById("bolivares").addEventListener('click', pagobs);
			// // document.getElementById("dolar").addEventListener('click', pagodolar);
		} else {
			reportepago(tipomoneda); 
			// document.getElementById("bolivares").removeEventListener('click', pagobs);
			// // document.getElementById("dolar").removeEventListener('click', pagodolar);
			// document.getElementById("bolivares").addEventListener('click', reportebs);
			// // document.getElementById("dolar").addEventListener('click', reportedolar);
		}
	} else {
