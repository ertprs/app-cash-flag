...
$urlcb = (isset($_GET['urlback'])) ? $_GET['urlback'] : 'https://app.cash-flag.com' ;
...
$urlok = 'https://app.cash-flag.com/php/exitocompraprepago.php?url='.$urlcb.'&registro='.$registro;

$okrequest = "https://app.cash-flag.com/php/procesaprepago.php?url=".$urlcb."&registro=".$registro;
...
// ------------------ O J O
$api = new apiPagoflash($key_public,$key_secret, $urlcb, true);
