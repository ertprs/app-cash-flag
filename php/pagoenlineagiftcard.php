...
$urlok = 'https://app.cash-flag.com/php/exitocompragiftcards.php?url='.$urlcb.'&registro='.$registro;

$okrequest = "https://app.cash-flag.com/php/procesagiftcard.php?url=".$urlcb."&registro=".$registro;
