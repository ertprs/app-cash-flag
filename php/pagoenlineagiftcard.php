...
$urlok = 'https://www.cash-flag.com/php/exitocompragiftcards.php?url='.$urlcb.'&registro='.$registro;

$okrequest = "https://www.cash-flag.com/php/procesagiftcard.php?url=".$urlcb."&registro=".$registro;
