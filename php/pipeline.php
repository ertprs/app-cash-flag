...
$cuenta2 = "sgcconsu_pruebas";
$password2 = "pruebas12345**";
$database2 = "sgcconsu_pruebas";
...
$query = "select TABLE_NAME from information_schema.tables where table_schema='sgcconsu_clubdeconsumidores'";
$result = mysqli_query($link1, $query);
while ($row = mysqli_fetch_array($result)) {
	echo $row["TABLE_NAME"].'<br/>';
	$quer2 = "select * from information_schema.columns where table_schema='sgcconsu_clubdeconsumidores' and table_name='".$row["TABLE_NAME"]."'";
