...
$query = "INSERT INTO tickets (cliente, sistema, modulo, tipo, detalles, impacto, nombre, email, telefono, fechaticket,severidad, status) VALUES ('".$_POST["cliente"]."','','','".$_POST["tipo"]."','".$_POST["detalles"]."','".$_POST["impacto"]."','".$_POST["nombre"]."','".$_POST["email"]."','".$_POST["telefono"]."','".$fecha."',".$severidad.",'Pendiente')";
$result = mysqli_query($link,$query);

$query = "SELECT ticket from tickets where cliente='".$_POST["cliente"]."' and sistema='' and modulo='' and nombre='".$_POST["nombre"]."' and fechaticket='".$fecha."'";
$result = mysqli_query($link,$query);
if ($row = mysqli_fetch_array($result)) {
	$ticket = $row["ticket"];
